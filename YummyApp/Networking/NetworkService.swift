...
//
// url - the path to our endpoint. What path in our backend we would like to fetch the resource
// method - the type of request we will be making
// parameters -  the are parameters included in the url
